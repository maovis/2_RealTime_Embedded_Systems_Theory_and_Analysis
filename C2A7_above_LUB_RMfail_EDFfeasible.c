...
//
// Service_1, S1, T1=3,  C1=1, D=T
// Service_2, S2, T2=6,  C2=2, D=T
// Service_3, S3, T3=9,  C3=3, D=T
//
...
// Servcie_1 = RT_MAX-1	@ 33.33 Hz,  T= 3
// Service_2 = RT_MAX-2	@ 16.67 Hz,  T= 6
// Service_3 = RT_MAX-3	@ 11.11 Hz   T= 9 
//
...
#define FIBONACCI_10MS_LOAD  900000
#define FIBONACCI_20MS_LOAD 1800000
#define FIBONACCI_30MS_LOAD 2700000
...
int main(void)
{
    ...
    calcFibonacci(FIBONACCI_30MS_LOAD);  
	
    // Open syslog
    openlog("[COURSE:2][ASSIGNMENT:7]", LOG_NDELAY, LOG_USER);
